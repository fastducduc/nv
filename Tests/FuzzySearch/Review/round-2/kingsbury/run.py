...
p.add_argument('--expect-fixed', action='store_true', help='Require the newer Reveal to win immediately and remain selected on repeated completion.')
a = p.parse_args()
out = ROOT / 'build/FuzzySearchReview/round-2/kingsbury' / ('sanitize' if a.sanitize else 'native')
